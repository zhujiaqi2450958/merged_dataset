...
# ====================== 【关键修改：crowded】 ======================
IMAGE_DIR = os.path.join(BASE_DIR, "crowded")                  # 拥挤图片
CSV_PATH = os.path.join(BASE_DIR, "crowded_annotations.csv")   # 拥挤标注CSV
OUTPUT_DIR = os.path.join(BASE_DIR, "processed_dataset_crowded")
CONFIG_NAME = "dataset_crowded.yaml"
# ==================================================================
...
if not os.path.exists(IMAGE_DIR):
    ...
    print("请确认 'crowded' 文件夹已复制到项目根目录")
    exit()
if not os.path.exists(CSV_PATH):
    print(f"❌ CSV文件不存在: {CSV_PATH}")
    print("请确认 'crowded_annotations.csv' 文件已复制到项目根目录")
    exit()
print("✅ 路径检查通过")
...
report_path = os.path.join(BASE_DIR, 'preprocess_report_crowded.txt')
